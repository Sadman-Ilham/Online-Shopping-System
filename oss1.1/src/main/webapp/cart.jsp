                                                        ...
                                                        <div class="row">
                                                            <div class="container-fluid">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 add-to text-right" >
                                                                    <a class="btn btn-sm btn-success" href="#"><i class="fa fa-credit-card"></i> <span class="icon-text">Buy Now</span></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="container-fluid">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                                        ...
                                                        <div class="row">
                                                            <div class="container-fluid">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 add-to text-right" >
                                                                    <a class="btn btn-sm btn-success" data-toggle="modal" href='#checkout-modal'><i class="fa fa-credit-card"></i> <span class="icon-text">Checkout</span></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 product-price text-center">
                        <div class="row">
                            <div class="container-fluid">
                                ...
                                <a class="btn btn-md btn-success" href="#"><i class="fa fa-credit-card"></i> <span class="icon-text">Buy All</span></a>
                            </div>
                        </div>
                    </div>
                </div>
